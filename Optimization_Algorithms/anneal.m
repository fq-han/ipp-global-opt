function [minimum,fval,nsamples,errk] = anneal(loss, parent, Maxit,options,xex,term_tol)
...
while ~finished
    ...
    nsamples = nsamples + 1;
    errk(nsamples) = my_error_opt(newparam,xex); 
